...
const Swatch: React.FC<{
  ...
  return (
    <label>
      ...
      />
      <div className="items-between flex h-full w-full flex-col justify-between gap-4 rounded-lg border-2 border-text-300 px-2 pb-3 pt-5 peer-checked:border-text-100 peer-checked:bg-white/5">
